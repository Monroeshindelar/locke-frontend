...
export const API_BASE_URL = `http://${process.env['API_BASE_URL_HOST']}:${process.env['API_BASE_URL_PORT']}`;

export const OAUTH2_REDIRECT_URL = `http://${process.env['API_BASE_URL_HOST']}:3000/oauth2/redirect`;
